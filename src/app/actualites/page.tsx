...
const actualites = [
  {
    ...
    date: "2026-01-15",
    resume:
      "ACDEV dévoile son nouveau plan stratégique axé sur 4 programmes d'intervention pour renforcer son impact au Cameroun.",
  ...
  },
  {
    ...
    date: "2025-12-20",
    resume:
      "Nos équipes ont sensibilisé plus de 700 enfants cette année sur la prévention des violences sexuelles et des enlèvements.",
  ...
  },
  {
    ...
    date: "2025-11-10",
    resume:
      "Programme d'autonomisation économique : 100 mères célibataires et victimes de violences ont reçu un soutien technique et financier.",
  ...
  },
  {
    ...
    date: "2024-06-15",
    resume:
      "Projet de résilience économique pour les réfugiés dans les régions de l'Est et de l'Adamaoua (2021-2024).",
  ...
  },
  {
    ...
    date: "2025-09-05",
    resume:
      "Plus de 3 000 élèves formés sur l'hygiène menstruelle et la santé reproductive dans les établissements scolaires partenaires.",
    categorie: "Programme II",
  ...
  },
  {
    ...
    date: "2026-05-11",
    resume:
      "Lancement de notre nouveau site web pour mieux communiquer sur nos actions et faciliter les dons en ligne.",
    categorie: "Digital",
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        ...
        title="Actualités"
        description="Découvrez nos dernières actions, nos événements, nos sensibilisations et les réussites menées avec les communautés sur le terrain."
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {actualites.map((article) => (
              ...
              >
                ...
                <p className="text-gray-700 mt-3">{article.resume}</p>
