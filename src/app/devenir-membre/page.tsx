...
const membresTypes = [
  {
    ...
    engagement: "Soutien libre selon vos possibilités",
    qui: [
  ...
  },
  {
    ...
    engagement: "Partenariat et appui institutionnel",
    qui: [
  ...
  },
  {
    ...
    engagement: "Engagement historique au sein d’ACDEV",
    qui: [
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        ...
        description="Rejoignez ACDEV et contribuez à notre mission de promotion des droits humains, de protection des personnes vulnérables et de prévention des violences basées sur le genre au Cameroun."
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                etape: "3",
                titre: "Confirmer",
                desc: "Confirmez votre engagement avec l’équipe ACDEV",
              },
              {
                etape: "4",
                titre: "Participer",
                desc: "Prenez part aux actions, rencontres et activités de l’association",
              },
            ].map((step, index) => (
